...
class CreateViewTransactionsIncomeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        \DB::statement(
            'CREATE VIEW view_transactions_income AS
            ...
            JOIN iomethods m ON m.id = t.iomethod_id WHERE c.output = 0'
        );
    }
