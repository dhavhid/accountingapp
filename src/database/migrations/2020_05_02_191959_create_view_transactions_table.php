...
class CreateViewTransactionsTable extends Migration
{
    ...
    public function up()
    {
        \DB::statement(
            ...
            c.title as categoryName, t.iomethod_id as methodId, m.title as methodName, t.description as description, c.output as isOutput,
            t.created_at as createdAt, t.updated_at as updatedAt FROM transactions t JOIN categories c ON t.category_id = c.id
            JOIN iomethods m ON m.id = t.iomethod_id'
        );
    }
